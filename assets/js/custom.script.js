...
(function($) {
    ...
    $(document).ready(function() {
		...
		if ( $('#lgx-countdown1').length ) {

            var dataTime = $('#lgx-countdown1').data('date'); // Date Format : Y/m/d

            $('#lgx-countdown1').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime(''
                    /*+ '<span class="lgx-weecks">%w <i> weeks </i></span> '*/
                    + '<span class="lgx-days">%D <i> Days </i></span> '
                    + '<span class="lgx-hr">%H <i> Hour </i></span> '
...
if ( $('#lgx-countdown2').length ) {

            var dataTime = $('#lgx-countdown2').data('date'); // Date Format : Y/m/d

            $('#lgx-countdown2').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime(''
                    /*+ '<span class="lgx-weecks">%w <i> weeks </i></span> '*/
                    + '<span class="lgx-days">%D <i> Days </i></span> '
                    + '<span class="lgx-hr">%H <i> Hour </i></span> '
        ...
        /* ==========================================================================
         SUBSCRIPTION & AJAX SUBMISSION
         ========================================================================== */
        /***********IMAGE MANIPULATION OF SPEAKERS */
        
        /*  var nizamiImage = document.getElementById("nizamiBrothersImage");
        if(window.innerHeight > window.innerWidth) {
            nizamiImage.src = "assets/img/speakers/nizamiBrothersPotrait.jpg";
        }
        else {
            nizamiImage.src = "assets/img/speakers/nizamiBrothers.jpg"
        } */
